...
<!-- Mirrored from templates.hibootstrap.com/medizo/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Sep 2025 06:56:57 GMT -->
<head>
        <!-- Required Meta Tags -->
        <meta charset="UTF-8">
        ...
        <!--=== Title ===-->
        <title>Medizo - Medical Health & Doctor Clinic HTML Template</title>
    ...
    <body>
                            ...
                            <div class="header-left-card">
                                <ul>
                                    <li>
                                        ...
                                        <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#4d25282121220d202829243722632e2220"><span class="__cf_email__" data-cfemail="fa929f969695ba979f9e938095d4999597">[email&#160;protected]</span></a>
                                    </li>
        ...
        <div class="navbar-area">
            ...
            <div class="mobile-nav">
                <a href="index.html" class="logo">
                    ...
                    <img src="img/logo-2.png" class="logo-two" alt="Logo">
                </a>
            </div>
                            ...
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="inc/register.php" class="nav-link">
                                                Sign Up
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="inc/register-2.php" class="nav-link">
                                                Terms & Conditions
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <li class="nav-item">
                                            <a href="inc/login.php" class="nav-link">
                                                Sign In
                                            </a>
                                        </li>
                            </ul>
        ...
        <div class="banner-area banner-bg">
            ...
            <div class="banner-img">
                <img src="img/home-one/home-one-img.png" alt="Images">
            </div>
            <div class="banner-shape">
                <div class="shape1">
                    <img src="img/home-one/shape1.png" alt="Images">
                </div>
                <div class="shape2">
                    <img src="img/home-one/shape2.png" alt="Images">
                </div>
            </div>
        </div>
        <!-- Banner Area End -->
                    ...
                    <div class="col-lg-6">
                        <div class="banner-bottom-card">
                            ...
                            <div class="content">
                                ...
                                <h3><a href="tel:812345678912">+8 (123) 456 789 12</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="about-area pt-100 pb-70">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="img/about-img/about-img.png" alt="Images">
                        </div>
                    </div>
        ...
        <div class="appointment-area appointment-bg pt-100 pb-70">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xxl-5">
                        <div class="appointment-img">
                            <img src="img/appointment/appointment-img.png" alt="Images">
                        </div>
                    </div>
            ...
            <div class="appointment-shape">
                <img src="img/appointment/appointment-shape.png" alt="Images">
            </div>
        </div>
        ...
        <section class="service-area pt-100 pb-70">
                ...
                <div class="row pt-45">
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <a href="service-details.html"><img src="img/services/service-img1.jpg" alt="Images"></a>
                            ...
                            <div class="service-shape-1">
                                <img src="img/services/service-shape1.png" alt="Images">
                            </div>
                            <div class="service-shape-2">
                                <img src="img/services/service-shape2.png" alt="Images">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <a href="service-details.html"><img src="img/services/service-img2.jpg" alt="Images"></a>
                            <div class="service-content">
                                <div class="service-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <a href="service-details.html"><img src="img/services/service-img3.jpg" alt="Images"></a>
                            <div class="service-content">
                                <div class="service-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <a href="service-details.html"><img src="img/services/service-img4.jpg" alt="Images"></a>
                            <div class="service-content">
                                <div class="service-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <a href="service-details.html"><img src="img/services/service-img5.jpg" alt="Images"></a>
                            <div class="service-content">
                                <div class="service-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card">
                            <a href="service-details.html"><img src="img/services/service-img6.jpg" alt="Images"></a>
                            <div class="service-content">
                                <div class="service-icon">
            ...
            <div class="service-dots">
                <img src="img/services/service-dots.png" alt="">
            </div>
        </section>
        <!-- Service Area End -->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="consultancy-img">
                            <img src="img/consultancy/consultancy-img.png" alt="Images">
                        </div>
                    </div>
        ...
        <div class="doctors-area ptb-100">
            <div class="container">
                ...
                <div class="doctors-slider owl-carousel owl-theme pt-45">
                    <div class="doctors-item">
                        <div class="doctors-img">
                            <a href="doctors-details.html">
                                <img src="img/doctors/doctors-img1.png" alt="Images">
                            </a>
                        </div>
                        <div class="content">
                    ...
                    <div class="doctors-item">
                        <div class="doctors-img">
                            <a href="doctors-details.html">
                                <img src="img/doctors/doctors-img2.png" alt="Images">
                            </a>
                        </div>
                        <div class="content">
                    ...
                    <div class="doctors-item">
                        <div class="doctors-img">
                            <a href="doctors-details.html">
                                <img src="img/doctors/doctors-img3.png" alt="Images">
                            </a>
                        </div>
                        <div class="content">
                    ...
                    <div class="doctors-item">
                        <div class="doctors-img">
                            <a href="doctors-details.html">
                                <img src="img/doctors/doctors-img4.png" alt="Images">
                            </a>
                        </div>
                        <div class="content">
            ...
            <div class="doctors-shape">
                <div class="doctors-shape-1">
                    <img src="img/doctors/doctors-shape1.png" alt="Images">
                </div>
                <div class="doctors-shape-2">
                    <img src="img/doctors/doctors-shape2.png" alt="Images">
                </div>
            </div>
        </div>
        <!-- Doctors Area End -->
        ...
        <div class="emergency-area ptb-100">
            ...
            <div class="emergency-shape">
                <img src="img/emergency/emergency-shape.png" alt="Images">
            </div>
        </div>
        <!-- Emergency Area End -->
            ...
            <div class="container">
                ...
                <div class="row pt-45">
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            <a href="blog-details.html">
                                <img src="img/blog/blog-img.jpg" alt="Images">
                            </a>
                            <div class="content">
                                <ul>
                                    <li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            <a href="blog-details.html">
                                <img src="img/blog/blog-img2.jpg" alt="Images">
                            </a>
                            <div class="content">
                                <ul>
                                    <li>
                        ...
                        <div class="blog-card-side">
                            <ul>
                                <li>
                                    ...
                                    <a href="blog-details.html">
                                        <h3> Advance Care Planning Information Session - 2024</h3>
                                    </a>
                                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="blog-more-btn">
                            <a href="blog-1.html" class="default-btn">Explore More</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row pt-45">
                    <div class="col-lg-6">
                        <div class="testimonials-img">
                            <img src="img/testimonials/testimonials-img.jpg" alt="Images">
                        </div>
                    </div>
                        ...
                        <div class="testimonials-slider-area">
                            <div class="testimonials-slider owl-carousel owl-theme">
                                <div class="testimonials-item">
                                    ...
                                    <div class="content">
                                        <img src="img/testimonials/testimonials-client1.jpg" alt="Images">
                                        <h3>Sinthy Alina</h3>
                                ...
                                <div class="testimonials-item">
                                    ...
                                    <p>Medizo hospital for their professional competent and committed approach they deliver at all times, making me and other patients feel at ease during these anxious times. </p>
                                    <div class="content">
                                        <img src="img/testimonials/testimonials-client2.jpg" alt="Images">
                                        <h3>Evanaa</h3>
            ...
            <div class="container">
                <div class="brand-slider owl-carousel owl-theme">
                    <div class="brand-item">
                        <img src="img/brand/brand-img1.png" class="brand-logo-one" alt="Images">
                        <img src="img/brand/brand-logo1.png" class="brand-logo-two" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="img/brand/brand-img2.png" class="brand-logo-one" alt="Images">
                        <img src="img/brand/brand-logo2.png" class="brand-logo-two" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="img/brand/brand-img3.png" class="brand-logo-one" alt="Images">
                        <img src="img/brand/brand-logo3.png" class="brand-logo-two" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="img/brand/brand-img4.png" class="brand-logo-one" alt="Images">
                        <img src="img/brand/brand-logo4.png" class="brand-logo-two" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="img/brand/brand-img5.png" class="brand-logo-one" alt="Images">
                        <img src="img/brand/brand-logo5.png" class="brand-logo-two" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="img/brand/brand-img6.png" class="brand-logo-one" alt="Images">
                        <img src="img/brand/brand-logo6.png" class="brand-logo-two" alt="Images">
                    </div>
                    <div class="brand-item">
                        <img src="img/brand/brand-img3.png" class="brand-logo-one" alt="Images">
                        <img src="img/brand/brand-logo3.png" class="brand-logo-two" alt="Images">
        ...
        <div class="subscribe-area ptb-100">
            ...
            <div class="subscribe-shape">
                <img src="img/subscribe-img/subscribe-shape.png" alt="Images">
            </div>
        </div>
        <!-- Subscribe Area End -->
                            ...
                            <ul class="footer-contact-list">
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="tel:0015481592492">+001-548-159-2492</a>
                                    </div>
                                </li>
                                <li>
                                    <i class='bx bxs-envelope'></i>
                                    <div class="content">
                                        <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#48202d24242708252d2c213227662b2725"><span class="__cf_email__" data-cfemail="b7dfd2dbdbd8f7dad2d3decdd899d4d8da">[email&#160;protected]</span></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget ps-2">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img src="img/logo.png" class="footer-logo1" alt="Images">
                                    <img src="img/logo-2.png" class="footer-logo2" alt="Images">
                                </a>
                            </div>
        ...
        <div class="copy-right-area">
            <div class="container">
                <div class="copy-right-text text-center">
                    <p>
                        Copyright © <script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear())</script> Medizo. All Rights Reserved by 
...
<!-- Mirrored from templates.hibootstrap.com/medizo/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Sep 2025 06:57:44 GMT -->
</html>